...
<div class="right">
	...
	<form id="userForm" enctype="multipart/form-data" name="userForm" method="post" action="${pageContext.request.contextPath }/user/useraddsave.html">
...
<!-- 					<select name="userRole" id="userRole"></select> -->
                ...
                <input type="text" id="errorinfo" value="${uploadFileError }">
            </form>
	</div>
</div>
</section>
