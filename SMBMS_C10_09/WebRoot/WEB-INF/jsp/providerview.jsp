...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>企业营业执照：</strong><img alt="" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.companyLicPicPath}"></p>
            <p><strong>组织机构代码：</strong><img alt="" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.orgCodePicPath}"></p>
